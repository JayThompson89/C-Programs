    ...
    public partial class Level_2 : Form
    {
        ...
        private void KeyisDown(object sender, KeyEventArgs e)
        {
            ...
            if (score == 75)
            {
                ...
                this.Show();
                Close();
                Level_2_Complete nextlevel = new Level_2_Complete();
                nextlevel.Show();
                GameTimer.Start();
        ...
        private void ShootDoubleBullet(string direction)
        {
            DoubleShot shootDoubleBullet = new DoubleShot();
            DoubleShot shootDoubleBullet2 = new DoubleShot();

            shootDoubleBullet.direction = direction;
            shootDoubleBullet2.direction = direction;

            shootDoubleBullet.bulletLeft = shooter.Left + (shooter.Width / 2);
            shootDoubleBullet.bulletTop = shooter.Top + (shooter.Height / 2);

            shootDoubleBullet2.bulletLeft = shooter.Left + (shooter.Width / 3);
            shootDoubleBullet2.bulletTop = shooter.Top + (shooter.Height / 3);

            shootDoubleBullet.MakeDoubleBullet(this);
            shootDoubleBullet2.MakeDoubleBullet(this);
